...
export default function WelcomeEmailTemplate({userName, userEmail, userPassword, link}: EmailVerificationProps) {
  return (
    <TemplateEmail
    ...
    >
      ...
      <TextEmail>
        Your account has been successfully created. To get started, please use the login details below:
      </TextEmail>

      <TextEmail style={{background: '#EEE', borderRadius: '4px', padding: '6px 12px'}}>
      ...
      <TextEmail>
        You can sign in at any time using your email and the password above. For security, we recommend changing your
