...
import {
  type PasswordResetInitFormRequest,
...
export default function ForgetPassword() {
  ...
  const onSubmit = (
    data: PasswordResetInitFormRequest,
    reset: UseFormReset<PasswordResetInitFormRequest>,
  ) => {
    setLoading(true);
        ...
        <Box w={"full"}>
          ...
          >
            <Fieldset.Root size="lg" maxW={"lg"} mx={"auto"}>
              ...
              <Stack>
                <Fieldset.Legend>Forget Password</Fieldset.Legend>
                <Fieldset.HelperText>
